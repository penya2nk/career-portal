...
<head>
    ...
    <title>BLST Career - Admin Page</title>
    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="./"><img src="{{asset('images/logohrmblst.png')}}" alt="Logo"></a>
                <a class="navbar-brand hidden" href="./"><img src="{{asset('images/logohrmblst.png')}}" alt="Logo"></a>
            </div>
