                        ...
                        <div class="card">
                          ...
                          <div class="card-body card-block">
                            ...
                            @foreach (App\models\stage::all() as $stages)
                              <div class="checkbox">
                                <label><input type="checkbox" @if(isset($status)) @if(in_array($stages->id,unserialize($job->stages_list))) checked @endif @endif name="stage[]" value="{{$stages->id}}"> {{$stages->stage_name}}</label>
                              </div>
                            @endforeach
                          </div>
                        </div>
